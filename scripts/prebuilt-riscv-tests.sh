...
do
    ...
    cp ~/rvdbt/prebuilts/riscv-tests/rv32ui-p-${isa_RV32UI} ~/rvdbt/build-llvm-19/troot/
...
do
    ...
    cp ~/rvdbt/prebuilts/riscv-tests/rv32um-p-${isa_RV32UM} ~/rvdbt/build-llvm-19/troot/
